...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate CaMCheX (ConvNeXt-Tiny + CXR-BERT-specialized).")
    add_common_args(parser, model_name="camchex_cxrbert", mode="eval")
    ...
    parser.add_argument("--predictions-path", default="output/camchex_cxrbert/predictions.csv")
    parser.add_argument("--metrics-path", default="output/camchex_cxrbert/metrics.json")
...
def main() -> None:
    ...
    evaluate_report_ablation(
        ...
        args=args,
        make_loader=lambda drop_report: make_camchex_eval_loader(cfg, args, drop_report=drop_report),
