...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate Prior-Aware v6 Nano (native-640-width fusion, pooled image path, multi-token text).")
    add_common_args(parser, model_name="prior_aware_v6nano", mode="eval")
