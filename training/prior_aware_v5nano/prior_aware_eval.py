...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate Prior-Aware v5 Nano (bottlenecked prior memory + detail-preserving current branch).")
    add_common_args(parser, model_name="prior_aware_v5nano", mode="eval")
