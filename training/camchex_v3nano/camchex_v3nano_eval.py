...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--predictions-path", default="output/camchex_v3nano/predictions.csv")
    parser.add_argument("--metrics-path", default="output/camchex_v3nano/metrics.json")
